...
public class RaspakovkaStroki2 {
    ...
    static String[] lineLength40(int num, String s) {
        //выясняю, делится ли строка ровно на указанную длинну выходной строки
...
//        if (lengthOfMassiv !=0) {
//            lengthOfMassiv = s.length()/num + 1;
//        } else {
//            //если делится нацело, длинна соотв. делению на макс. значение знаков в вых. строке
//            lengthOfMassiv = s.length()/num;
//        }
